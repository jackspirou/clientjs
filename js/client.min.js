...
(function(){4==a.readyState?a.parentNode.removeChild(a):setTimeout(arguments.callee,10)})()}else a.parentNode.replaceChild(t(a),a)}function t(a){var c=l.createElement("div");if(k.win&&k.ie)c.innerHTML=a.innerHTML;else if(a=a.getElementsByTagName("object")[0])if(a=a.childNodes)for(var h=a.length,b=0;b<h;b++)1==a[b].nodeType&&"PARAM"==a[b].nodeName||8==a[b].nodeType||c.appendChild(a[b].cloneNode(!0));return c}function a(a,c,b){var e,f=h(b);if(k.wk&&312>k.wk)return e;if(f)if("undefined"==typeof a.id&&
(a.id=b),k.ie&&k.win){var d="",m;for(m in a)a[m]!=Object.prototype[m]&&("data"==m.toLowerCase()?c.movie=a[m]:"styleclass"==m.toLowerCase()?d+=' class="'+a[m]+'"':"classid"!=m.toLowerCase()&&(d+=" "+m+'="'+a[m]+'"'));m="";for(var n in c)c[n]!=Object.prototype[n]&&(m+='<param name="'+n+'" value="'+c[n]+'" />');f.outerHTML='<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"'+d+">"+m+"</object>";H[H.length]=a.id;e=h(a.id)}else{n=l.createElement("object");n.setAttribute("type","application/x-shockwave-flash");
for(var g in a)a[g]!=Object.prototype[g]&&("styleclass"==g.toLowerCase()?n.setAttribute("class",a[g]):"classid"!=g.toLowerCase()&&n.setAttribute(g,a[g]));for(d in c)c[d]!=Object.prototype[d]&&"movie"!=d.toLowerCase()&&(a=n,m=d,g=c[d],b=l.createElement("param"),b.setAttribute("name",m),b.setAttribute("value",g),a.appendChild(b));f.parentNode.replaceChild(n,f);e=n}return e}function c(a){var c=h(a);c&&"OBJECT"==c.nodeName&&(k.ie&&k.win?(c.style.display="none",function(){if(4==c.readyState){var b=h(a);
...
"$1"),10),e[1]=parseInt(f.replace(/^.*\.(.*)\s.*$/,"$1"),10),e[2]=/[a-zA-Z]/.test(f)?parseInt(f.replace(/^.*[a-zA-Z]+(.*)$/,"$1"),10):0);else if("undefined"!=typeof u.ActiveXObject)try{var m=new ActiveXObject("ShockwaveFlash.ShockwaveFlash");m&&(f=m.GetVariable("$version"))&&(d=!0,f=f.split(" ")[1].split(","),e=[parseInt(f[0],10),parseInt(f[1],10),parseInt(f[2],10)])}catch(n){}return{w3:a,pv:e,wk:c,ie:d,win:h,mac:b}}();(function(){k.w3&&(("undefined"!=typeof l.readyState&&"complete"==l.readyState||
...
embedSWF:function(c,b,h,d,f,m,n,g,l,v){var u={success:!1,id:b};k.w3&&!(k.wk&&312>k.wk)&&c&&b&&h&&d&&f?(z(b,!1),e(function(){h+="";d+="";var e={};if(l&&"object"===typeof l)for(var k in l)e[k]=l[k];e.data=c;e.width=h;e.height=d;k={};if(g&&"object"===typeof g)for(var r in g)k[r]=g[r];if(n&&"object"===typeof n)for(var t in n)k.flashvars="undefined"!=typeof k.flashvars?k.flashvars+("&"+t+"="+n[t]):t+"="+n[t];if(D(f))r=a(e,k,b),e.id==b&&z(b,!0),u.success=!0,u.ref=r;else{if(m&&p()){e.data=m;q(e,k,b,v);return}z(b,
...
this.oldMimeType+'" hidden="true" />')}}};p.writePluginTag();if(null==p.locale){d=null;if(null==d)try{d=navigator.userLanguage}catch(q){}if(null==d)try{d=navigator.systemLanguage}catch(r){}if(null==d)try{d=navigator.language}catch(t){}null!=d&&(d.replace("-","_"),p.locale=d)}return p}();(function(f){var e,d=function(){e=(new UAParser).getResult();return this};d.prototype={getSoftwareVersion:function(){return"ClientJS 0.05"},getBrowserData:function(){return e},getFingerprint:function(){var d=e.ua,b=this.getScreenPrint(),f=this.getPlugins(),p=this.getFonts(),q=this.isLocalStorage(),r=this.isSessionStorage(),t=this.getTimeZone(),a=this.getLanguage(),c=this.getSystemLanguage(),h=this.isCookie(),v=this.getCanvasPrint();return murmurhash3_32_gc(d+"|"+b+"|"+f+"|"+p+"|"+q+"|"+r+"|"+t+"|"+
