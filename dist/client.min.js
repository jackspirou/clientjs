...
getCanvasPrint:!0,getIPAddresses:!1}};b.prototype.extendOptions=function(a,b){for(var c in b)a[c]=b[c];return a};b.prototype.getVersion=function(){return this._version};b.prototype.getParser=function(){return this._parser};b.prototype.getFingerprint=function(){var a=this._parser.ua,b=this.getScreenPrint(),c=this.getPlugins(),d=this.getFonts(),k=this.hasLocalStorage(),f=this.hasSessionStorage(),p=this.getTimeZone(),r=this.getLanguage(),h=this.getSystemLanguage(),g=this.hasCookies(),l=this.getCanvasPrint();
return murmurhash3_32_gc(a+"|"+b+"|"+c+"|"+d+"|"+k+"|"+f+"|"+p+"|"+r+"|"+h+"|"+g+"|"+l,256)};b.prototype.getFingerprintAsync=function(a,b){var c="",d=this,k={},f=this.options,f=this.extendOptions(f,a);this.getIPAddressesOption(function(a){if(a||""===a)c+=a.localAddr+"|"+a.publicAddr+"|",k.getIPAddresses=a;for(var r in f)!0===f[r]&&"getIPAddresses"!==r&&(a=d[r](),c+=a+"|",k[r]=a);b(ctph.digest(c),k)})};b.prototype.getCustomFingerprint=function(a){for(var b="",c=Array.prototype.slice.call(arguments),
d=0;d<c.length;d++)b+=c[d]+"|";return murmurhash3_32_gc(b,256)};b.prototype.getIPAddressesOption=function(a){1==this.options.getIPAddresses?this.getIPAddresses(function(b){a(b)}):a()};b.prototype.getUserAgent=function(){return this._parser.ua};b.prototype.getUserAgentLowerCase=function(){return this._parser.ua.toLowerCase()};b.prototype.getBrowser=function(){return this._parser.browser.name};b.prototype.getBrowserVersion=function(){return this._parser.browser.version};b.prototype.getBrowserMajorVersion=
function(){return this._parser.browser.major};b.prototype.getIPAddresses=function(a){function b(a){a=/([0-9]{1,3}(\.[0-9]{1,3}){3}|[a-f0-9]{1,4}(:[a-f0-9]{1,4}){7})/.exec(JSON.stringify(a))[1];void 0===k[a]&&(k[a]=!0,a.match(/^(192\.168\.|169\.254\.|10\.|172\.(1[6-9]|2\d|3[01]))/)?d.localAddr=a:a.match(/^[a-f0-9]{1,4}(:[a-f0-9]{1,4}){7}$/)?d.ipv6=a:d.publicAddr=a)}function c(){w=null;h.localDescription.sdp.split("\n").forEach(function(a){0===a.indexOf("a=candidate:")?(l++,b(a)):0===a.indexOf("a=fingerprint:")&&
(d.fingerprint=a.substring(14,a.length))});a&&a(d)}var d={},k={},f=window.RTCPeerConnection||window.mozRTCPeerConnection||window.webkitRTCPeerConnection;if(f){try{if(!f){this._makeWebRTCFrame("webRTC_iframe");var p=k.contentWindow,f=p.RTCPeerConnection||p.mozRTCPeerConnection||p.webkitRTCPeerConnection}}catch(e){a&&a("")}var p={optional:[{RtpDataChannels:!0}]},r={iceServers:[{urls:"stun:stun.services.mozilla.com"}]};try{var h=new f(r,p)}catch(e){a&&a("")}var g=0,l=0,w;h.onicecandidate=function(a){if(a.candidate){g++;
b(a.candidate.candidate);try{clearTimeout(w)}catch(k){}w=setTimeout(c,150)}};h.createDataChannel(null);h.createOffer(function(a){h.setLocalDescription(a,function(){},function(){})},function(){})}else a&&a("")};b.prototype._makeWebRTCFrame=function(a){var b=document.createElement("iframe");b.setAttribute("id",a);b.setAttribute("sandbox","allow-same-origin");b.setAttribute("style","display: none");document.getElementsByTagName("body")[0].appendChild(b)};b.prototype.isIE=function(){return/IE/i.test(this._parser.browser.name)};
b.prototype.isChrome=function(){return/Chrome/i.test(this._parser.browser.name)};b.prototype.isFirefox=function(){return/Firefox/i.test(this._parser.browser.name)};b.prototype.isSafari=function(){return/Safari/i.test(this._parser.browser.name)};b.prototype.isMobileSafari=function(){return/Mobile\sSafari/i.test(this._parser.browser.name)};b.prototype.isOpera=function(){return/Opera/i.test(this._parser.browser.name)};b.prototype.getEngine=function(){return this._parser.engine.name};b.prototype.getEngineVersion=
...
c.fillText(a,2,15);c.fillStyle="rgba(102, 204, 0, 0.7)";c.fillText(a,4,17);return b.toDataURL()};b.prototype.getWebglFingerprint=function(){var a,b=function(k){a.clearColor(0,0,0,1);a.enable(a.DEPTH_TEST);a.depthFunc(a.LEQUAL);a.clear(a.COLOR_BUFFER_BIT|a.DEPTH_BUFFER_BIT);return"["+k[0]+", "+k[1]+"]"};a=this.createWebglCanvas();if(!a)return"";var c=[],d=a.createBuffer();a.bindBuffer(a.ARRAY_BUFFER,d);var k=new Float32Array([-.2,-.9,0,.4,-.26,0,0,.732134444,0]);a.bufferData(a.ARRAY_BUFFER,k,a.STATIC_DRAW);
d.itemSize=3;d.numItems=3;var k=a.createProgram(),f=a.createShader(a.VERTEX_SHADER);a.shaderSource(f,"attribute vec2 attrVertex;varying vec2 varyinTexCoordinate;uniform vec2 uniformOffset;void main(){varyinTexCoordinate=attrVertex+uniformOffset;gl_Position=vec4(attrVertex,0,1);}");a.compileShader(f);var p=a.createShader(a.FRAGMENT_SHADER);a.shaderSource(p,"precision mediump float;varying vec2 varyinTexCoordinate;void main() {gl_FragColor=vec4(varyinTexCoordinate,0,1);}");a.compileShader(p);a.attachShader(k,
f);a.attachShader(k,p);a.linkProgram(k);a.useProgram(k);k.vertexPosAttrib=a.getAttribLocation(k,"attrVertex");k.offsetUniform=a.getUniformLocation(k,"uniformOffset");a.enableVertexAttribArray(k.vertexPosArray);a.vertexAttribPointer(k.vertexPosAttrib,d.itemSize,a.FLOAT,!1,0,0);a.uniform2f(k.offsetUniform,1,1);a.drawArrays(a.TRIANGLE_STRIP,0,d.numItems);null!=a.canvas&&c.push(a.canvas.toDataURL());c.push("extensions:"+a.getSupportedExtensions().join(";"));c.push("webgl aliased line width range:"+b(a.getParameter(a.ALIASED_LINE_WIDTH_RANGE)));
c.push("webgl aliased point size range:"+b(a.getParameter(a.ALIASED_POINT_SIZE_RANGE)));c.push("webgl alpha bits:"+a.getParameter(a.ALPHA_BITS));c.push("webgl antialiasing:"+(a.getContextAttributes().antialias?"yes":"no"));c.push("webgl blue bits:"+a.getParameter(a.BLUE_BITS));c.push("webgl depth bits:"+a.getParameter(a.DEPTH_BITS));c.push("webgl green bits:"+a.getParameter(a.GREEN_BITS));c.push("webgl max anisotropy:"+function(a){var k,f=a.getExtension("EXT_texture_filter_anisotropic")||a.getExtension("WEBKIT_EXT_texture_filter_anisotropic")||
a.getExtension("MOZ_EXT_texture_filter_anisotropic");return f?(k=a.getParameter(f.MAX_TEXTURE_MAX_ANISOTROPY_EXT),0===k&&(k=2),k):null}(a));c.push("webgl max combined texture image units:"+a.getParameter(a.MAX_COMBINED_TEXTURE_IMAGE_UNITS));c.push("webgl max cube map texture size:"+a.getParameter(a.MAX_CUBE_MAP_TEXTURE_SIZE));c.push("webgl max fragment uniform vectors:"+a.getParameter(a.MAX_FRAGMENT_UNIFORM_VECTORS));c.push("webgl max render buffer size:"+a.getParameter(a.MAX_RENDERBUFFER_SIZE));
...
a.LOW_INT).precision),c.push("webgl fragment shader low int precision rangeMin:"+a.getShaderPrecisionFormat(a.FRAGMENT_SHADER,a.LOW_INT).rangeMin),c.push("webgl fragment shader low int precision rangeMax:"+a.getShaderPrecisionFormat(a.FRAGMENT_SHADER,a.LOW_INT).rangeMax)):"undefined"===typeof NODEBUG&&console.log("This browser does not support getShaderPrecisionFormat. Ignoring it.");return c.join("|")};b.prototype.createWebglCanvas=function(){var a=document.createElement("canvas"),b=null;try{b=a.getContext("webgl")||
a.getContext("experimental-webgl")}catch(c){}b||(b=null);return b};b.prototype._ipAddressesFilter=function(a){0==this.filters.ipAddresses?a(""):this.getIPAddresses(function(b){b?a(b.publicAddr+"|"+b.localAddr+"|"+b.ipv6+"|"):a(null)})};e.ClientJS=b})(window);(function(){function e(a,f){if(a===f)return 0;if(0===a.length)return f.length;if(0===f.length)return a.length;var b=Array(f.length+1),c,h,g,l,d;for(g=0;g<b.length;++g)b[g]=g;for(g=0;g<a.length;++g){h=g+1;for(l=0;l<f.length;++l)c=h,h=b[l]+(a.charAt(g)===f.charAt(l)?0:1),d=c+1,h>d&&(h=d),d=b[l+1]+1,h>d&&(h=d),b[l]=c;b[l]=h}return h}function b(){this.c=this.z=this.y=this.x=0;this.window=Array(7)}function a(a,f){for(var c=["",""],d=671226215,h=671226215,g=new b,l=0,e=a.length;l<e;l++){d=(16777619*d^a[l])>>>
0;h=(16777619*h^a[l])>>>0;g.update(a[l]);if(l===e-1||g.sum()%f===f-1)c[0]+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(d&63),d=671226215;if(l===e-1||g.sum()%(2*f)===2*f-1)c[1]+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(h&63),h=671226215}return c}function q(a,f){return 100*(1-e(a,f)/Math.max(a.length,f.length))}var c={},d=!1;"undefined"!==typeof module&&module.exports?exports=module.exports=c:(this.ctph=c,d=!0);b.prototype.update=function(a){this.y-=
this.x;this.y+=7*a;this.x+=a;this.x-=this.window[this.c%7]||0;this.window[this.c%7]=a;this.c++;this.z=this.z<<5>>>0;this.z=(this.z^a)>>>0};b.prototype.sum=function(){return this.x+this.y+this.z>>>0};c.digest=function(k){if("string"===typeof k)if(d){k=unescape(encodeURIComponent(k));for(var f=[],b=0;b<k.length;b++)f.push(k.charCodeAt(b));k=f}else k=(new Buffer(k)).toJSON();f=Math.ceil(Math.log(k.length/192)/Math.log(2));f=Math.max(3,f);for(b=a(k,3<<f);0<f&&32>b[0].length;)b=a(k,3<<--f);return"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(f)+
":"+b[0]+":"+b[1]};c.similarity=function(a,b){var c="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(a.charAt(0)),d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(b.charAt(0));return c>d?arguments.callee(b,a):1<Math.abs(c-d)?0:c===d?q(a.split(":")[1],b.split(":")[1]):q(a.split(":")[2],b.split(":")[1])}})();var deployJava=function(){function e(a){d.debug&&(console.log?console.log(a):alert(a))}function b(a){if(null==a||0==a.length)return"http://java.com/dt-redirect";"&"==a.charAt(0)&&(a=a.substring(1,a.length));return"http://java.com/dt-redirect?"+a}var a=["id","class","title","style"];"classid codebase codetype data type archive declare standby height width usemap name tabindex align border hspace vspace".split(" ").concat(a,["lang","dir"],"onclick ondblclick onmousedown onmouseup onmouseover onmousemove onmouseout onkeypress onkeydown onkeyup".split(" "));
var q="codebase code name archive object width height alt align hspace vspace".split(" ").concat(a),c;try{c=-1!=document.location.protocol.indexOf("http")?"//java.com/js/webstart.png":"http://java.com/js/webstart.png"}catch(k){c="http://java.com/js/webstart.png"}var d={debug:null,version:"20120801",firefoxJavaVersion:null,myInterval:null,preInstallJREList:null,returnPage:null,brand:null,locale:null,installType:null,EAInstallEnabled:!1,EarlyAccessURL:null,oldMimeType:"application/npruntime-scriptable-plugin;DeploymentToolkit",
...
t;D++)"movie"!=e[D].getAttribute("name").toLowerCase()&&(n[e[D].getAttribute("name")]=e[D].getAttribute("value"));f(g,n,c,h)}else p(e),h&&h(g);else B(c,!0),h&&(g.success=!0,g.ref=d(c),h(g))}else B(c,!0),h&&((c=d(c))&&"undefined"!=typeof c.SetVariable&&(g.success=!0,g.ref=c),h(g))}}function d(a){var b=null;(a=l(a))&&"OBJECT"==a.nodeName&&("undefined"!=typeof a.SetVariable?b=a:(a=a.getElementsByTagName("object")[0])&&(b=a));return b}function k(){return!G&&y("6.0.65")&&(m.win||m.mac)&&!(m.wk&&312>m.wk)}
function f(a,b,c,d){G=!0;J=d||null;L={success:!1,id:c};var g=l(c);if(g){"OBJECT"==g.nodeName?(E=r(g),H=null):(E=g,H=c);a.id="SWFObjectExprInst";if("undefined"==typeof a.width||!/%$/.test(a.width)&&310>parseInt(a.width,10))a.width="310";if("undefined"==typeof a.height||!/%$/.test(a.height)&&137>parseInt(a.height,10))a.height="137";n.title=n.title.slice(0,47)+" - Flash Player Installation";d=m.ie&&m.win?"ActiveX":"PlugIn";d="MMredirectURL="+u.location.toString().replace(/&/g,"%26")+"&MMplayerType="+
...
(function(){4==a.readyState?a.parentNode.removeChild(a):setTimeout(arguments.callee,10)})()}else a.parentNode.replaceChild(r(a),a)}function r(a){var b=n.createElement("div");if(m.win&&m.ie)b.innerHTML=a.innerHTML;else if(a=a.getElementsByTagName("object")[0])if(a=a.childNodes)for(var c=a.length,d=0;d<c;d++)1==a[d].nodeType&&"PARAM"==a[d].nodeName||8==a[d].nodeType||b.appendChild(a[d].cloneNode(!0));return b}function h(a,b,c){var d,h=l(c);if(m.wk&&312>m.wk)return d;if(h)if("undefined"==typeof a.id&&
(a.id=c),m.ie&&m.win){var g="",e;for(e in a)a[e]!=Object.prototype[e]&&("data"==e.toLowerCase()?b.movie=a[e]:"styleclass"==e.toLowerCase()?g+=' class="'+a[e]+'"':"classid"!=e.toLowerCase()&&(g+=" "+e+'="'+a[e]+'"'));e="";for(var k in b)b[k]!=Object.prototype[k]&&(e+='<param name="'+k+'" value="'+b[k]+'" />');h.outerHTML='<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"'+g+">"+e+"</object>";I[I.length]=a.id;d=l(a.id)}else{k=n.createElement("object");k.setAttribute("type","application/x-shockwave-flash");
for(var f in a)a[f]!=Object.prototype[f]&&("styleclass"==f.toLowerCase()?k.setAttribute("class",a[f]):"classid"!=f.toLowerCase()&&k.setAttribute(f,a[f]));for(g in b)b[g]!=Object.prototype[g]&&"movie"!=g.toLowerCase()&&(a=k,e=g,f=b[g],c=n.createElement("param"),c.setAttribute("name",e),c.setAttribute("value",f),a.appendChild(c));h.parentNode.replaceChild(k,h);d=k}return d}function g(a){var b=l(a);b&&"OBJECT"==b.nodeName&&(m.ie&&m.win?(b.style.display="none",function(){if(4==b.readyState){var c=l(a);
...
"$1"),10),g[1]=parseInt(e.replace(/^.*\.(.*)\s.*$/,"$1"),10),g[2]=/[a-zA-Z]/.test(e)?parseInt(e.replace(/^.*[a-zA-Z]+(.*)$/,"$1"),10):0);else if("undefined"!=typeof u.ActiveXObject)try{var l=new ActiveXObject("ShockwaveFlash.ShockwaveFlash");l&&(e=l.GetVariable("$version"))&&(h=!0,e=e.split(" ")[1].split(","),g=[parseInt(e[0],10),parseInt(e[1],10),parseInt(e[2],10)])}catch(k){}return{w3:a,pv:g,wk:b,ie:h,win:d,mac:c}}();(function(){m.w3&&(("undefined"!=typeof n.readyState&&"complete"==n.readyState||
...
if(null==a)return N(b);for(var b=b.split("&"),c=0;c<b.length;c++)if(b[c].substring(0,b[c].indexOf("="))==a)return N(b[c].substring(b[c].indexOf("=")+1))}return""},expressInstallCallback:function(){if(G){var a=l("SWFObjectExprInst");a&&E&&(a.parentNode.replaceChild(E,a),H&&(B(H,!0),m.ie&&m.win&&(E.style.display="block")),J&&J(L));G=!1}}}}();(function(e,b){var a={extend:function(a,b){for(var c in b)-1!=="browser cpu device engine os".indexOf(c)&&0===b[c].length%2&&(a[c]=b[c].concat(a[c]));return a},has:function(a,b){return"string"===typeof a?-1!==b.toLowerCase().indexOf(a.toLowerCase()):!1},lowerize:function(a){return a.toLowerCase()},major:function(a){return"string"===typeof a?a.split(".")[0]:b}},q=function(){for(var a,c=0,d,e,k,f,p,q,r=arguments;c<r.length&&!p;){var n=r[c],v=r[c+1];if("undefined"===typeof a)for(k in a={},v)v.hasOwnProperty(k)&&
(f=v[k],"object"===typeof f?a[f[0]]=b:a[f]=b);for(d=e=0;d<n.length&&!p;)if(p=n[d++].exec(this.getUA()))for(k=0;k<v.length;k++)q=p[++e],f=v[k],"object"===typeof f&&0<f.length?2==f.length?a[f[0]]="function"==typeof f[1]?f[1].call(this,q):f[1]:3==f.length?a[f[0]]="function"!==typeof f[1]||f[1].exec&&f[1].test?q?q.replace(f[1],f[2]):b:q?f[1].call(this,q,f[2]):b:4==f.length&&(a[f[0]]=q?f[3].call(this,q.replace(f[1],f[2])):b):a[f]=q?q:b;c+=2}return a},c=function(c,d){for(var e in d)if("object"===typeof d[e]&&
...
/(unix)\s?([\w\.]+)*/i],["name","version"]]},f=function(b,c){if(!(this instanceof f))return(new f(b,c)).getResult();var d=b||(e&&e.navigator&&e.navigator.userAgent?e.navigator.userAgent:""),p=c?a.extend(k,c):k;this.getBrowser=function(){var b=q.apply(this,p.browser);b.major=a.major(b.version);return b};this.getCPU=function(){return q.apply(this,p.cpu)};this.getDevice=function(){return q.apply(this,p.device)};this.getEngine=function(){return q.apply(this,p.engine)};this.getOS=function(){return q.apply(this,
...
EMBEDDED:"embedded"};f.ENGINE={NAME:"name",VERSION:"version"};f.OS={NAME:"name",VERSION:"version"};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=f),exports.UAParser=f):"function"===typeof define&&define.amd?define(function(){return f}):e.UAParser=f;var p=e.jQuery||e.Zepto;if("undefined"!==typeof p){var r=new f;p.ua=r.getResult();p.ua.get=function(){return r.getUA()};p.ua.set=function(a){r.setUA(a);a=r.getResult();for(var b in a)p.ua[b]=a[b]}}})("object"===
